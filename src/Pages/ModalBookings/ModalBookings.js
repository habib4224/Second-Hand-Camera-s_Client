...
const ModalBookings = ({ modaldetails, setModalDetails }) => {
    const { Product_Name, Resell_Price } = modaldetails;
        ...
        <>
            ...
            <div className="modal">
                <div className="modal-box relative">
                    ...
                    <h3 className="text-lg font-bold">Item Name: {Product_Name}</h3>
                    <form onSubmit={handleBooking} className='grid grid-cols-1 gap-5'>
                        ...
                        <input name='phone' type="text" placeholder="Give Your Phone Number" className="input input-bordered w-full " />
                        <input name='meeting' type="text" placeholder="Provide Meeting Location" className="input input-bordered w-full " />
                        <br />
