...
const AboutOurService = () => {
    return (
        <div className="hero h-screen my-8" style={{ backgroundImage: `url('https://cdn.fstoppers.com/styles/large-16-9/s3/lead/2015/12/sell-gear-online-craigslist-offerup-local-fstoppers-casey-berner.jpg')` }}>
